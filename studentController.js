...
const studentLogout = (req, res) => {
    ...
    req.session.destroy(err => {
        if (err) {
            ...
            return res.redirect('/student/dashboard'); // Redirect to student dashboard or an error page
        }
...
module.exports = {
    ...
    studentLogout // Make sure to export the new logout function
};
